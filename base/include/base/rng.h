...
#define BASE_RNG_H_HEADER_GUARD
...
namespace base
{
	...
	template <typename Rng>
	base::Vec3 randUnitCircle(Rng* _rng);

	/// Generate random point on unit sphere.
	template <typename Rng>
	base::Vec3 randUnitSphere(Rng* _rng);

	/// Generate random point on unit hemisphere.
	template <typename Ty>
	base::Vec3 randUnitHemisphere(Ty* _rng, const base::Vec3& _normal);
