...
#ifndef BASE_RINGBUFFER_H_HEADER_GUARD
#define BASE_RINGBUFFER_H_HEADER_GUARD
...
namespace base
{
	...
	{
		BASE_CLASS(SpScRingBufferControl
			, NO_DEFAULT_CTOR
			, NO_COPY
			);
...
#endif // BASE_RINGBUFFER_H_HEADER_GUARD
