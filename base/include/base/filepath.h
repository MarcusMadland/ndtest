...
#ifndef BASE_FILEPATH_H_HEADER_GUARD
#define BASE_FILEPATH_H_HEADER_GUARD
...
namespace base
{
	BASE_ERROR_RESULT(kErrorAccess,       BASE_MAKEFOURCC('b', 'x', 1, 1) );
	BASE_ERROR_RESULT(kErrorNotDirectory, BASE_MAKEFOURCC('b', 'x', 1, 2) );
...
#endif // BASE_FILEPATH_H_HEADER_GUARD
