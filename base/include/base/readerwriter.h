...
#ifndef BASE_READERWRITER_H_HEADER_GUARD
#define BASE_READERWRITER_H_HEADER_GUARD
...
namespace base
{
	BASE_ERROR_RESULT(kErrorReaderWriterOpen,        BASE_MAKEFOURCC('b', 'x', 2, 1) );
	BASE_ERROR_RESULT(kErrorReaderWriterRead,        BASE_MAKEFOURCC('b', 'x', 2, 2) );
	BASE_ERROR_RESULT(kErrorReaderWriterWrite,       BASE_MAKEFOURCC('b', 'x', 2, 3) );
	BASE_ERROR_RESULT(kErrorReaderWriterEof,         BASE_MAKEFOURCC('b', 'x', 2, 4) );
	BASE_ERROR_RESULT(kErrorReaderWriterAlreadyOpen, BASE_MAKEFOURCC('b', 'x', 2, 5) );
	...
	struct BASE_NO_VTABLE ReaderSeekerI : public ReaderI, public SeekerI
	{
	};

	/// Writer seeker interface.
	struct BASE_NO_VTABLE WriterSeekerI : public WriterI, public SeekerI
	{
	};

	/// Open for reading interface.
	struct BASE_NO_VTABLE ReaderOpenI
	{
		///
	...
	struct BASE_NO_VTABLE WriterOpenI
	{
		///
	...
	struct BASE_NO_VTABLE ProcessOpenI
	{
		///
	...
	struct BASE_NO_VTABLE FileReaderI : public ReaderOpenI, public CloserI, public ReaderSeekerI
	{
	};

	/// File writer interface.
	struct BASE_NO_VTABLE FileWriterI : public WriterOpenI, public CloserI, public WriterSeekerI
	{
	};

	/// Memory block interface.
	struct BASE_NO_VTABLE MemoryBlockI
	{
...
#endif // BASE_READERWRITER_H_HEADER_GUARD
