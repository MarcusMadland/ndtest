...
#ifndef BASE_SORT_H_HEADER_GUARD
#	error "Must be included from base/sort.h!"
#endif // BASE_SORT_H_HEADER_GUARD
...
namespace base
{
	...
	{
		BASE_STATIC_ASSERT(isTriviallyMoveAssignable<Ty>(), "Element type must be trivially move assignable");
	...
	{
		BASE_STATIC_ASSERT(isTriviallyMoveAssignable<Ty>(), "Sort element type must be trivially move assignable");
