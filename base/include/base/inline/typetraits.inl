...
#ifndef BASE_TYPETRAITS_H_HEADER_GUARD
#	error "Must be included from base/typetraits.h!"
#endif // BASE_TYPETRAITS_H_HEADER_GUARD
...
namespace base
{
	...
	inline constexpr Ty&& forward(RemoveReferenceType<Ty>&& _a)
	{
		BASE_STATIC_ASSERT(!isLvalueReference<Ty>(), "Can not forward an Rvalue as an Lvalue.");
		return static_cast<Ty&&>(_a);
	}
