...
#ifndef BASE_MATH_H_HEADER_GUARD
#	error "Must be included from base/math.h!"
#endif // BASE_MATH_H_HEADER_GUARD
...
namespace base
{
	inline BASE_CONSTEXPR_FUNC float toRad(float _deg)
	{
		return _deg * kPi / 180.0f;
	}

	inline BASE_CONSTEXPR_FUNC float toDeg(float _rad)
	{
		return _rad * 180.0f / kPi;
	}

	inline BASE_CONST_FUNC uint32_t floatToBits(float _a)
	{
		union { float f; uint32_t ui; } u = { _a };
		return u.ui;
	}

	inline BASE_CONST_FUNC float bitsToFloat(uint32_t _a)
	{
		union { uint32_t ui; float f; } u = { _a };
		return u.f;
	}

	inline BASE_CONST_FUNC uint64_t doubleToBits(double _a)
	{
		union { double f; uint64_t ui; } u = { _a };
		return u.ui;
	}

	inline BASE_CONST_FUNC double bitsToDouble(uint64_t _a)
	{
		union { uint64_t ui; double f; } u = { _a };
		return u.f;
	}

	inline BASE_CONST_FUNC uint32_t floatFlip(uint32_t _value)
	{
		// Reference(s):
	...
	inline BASE_CONST_FUNC bool isNan(float _f)
	{
		const uint32_t tmp = floatToBits(_f) & INT32_MAX;
		return tmp > kFloatExponentMask;
	}

	inline BASE_CONST_FUNC bool isNan(double _f)
	{
		const uint64_t tmp = doubleToBits(_f) & INT64_MAX;
		return tmp > kDoubleExponentMask;
	}

	inline BASE_CONST_FUNC bool isFinite(float _f)
	{
		const uint32_t tmp = floatToBits(_f) & INT32_MAX;
		return tmp < kFloatExponentMask;
	}

	inline BASE_CONST_FUNC bool isFinite(double _f)
	{
		const uint64_t tmp = doubleToBits(_f) & INT64_MAX;
		return tmp < kDoubleExponentMask;
	}

	inline BASE_CONST_FUNC bool isInfinite(float _f)
	{
		const uint32_t tmp = floatToBits(_f) & INT32_MAX;
		return tmp == kFloatExponentMask;
	}

	inline BASE_CONST_FUNC bool isInfinite(double _f)
	{
		const uint64_t tmp = doubleToBits(_f) & INT64_MAX;
		return tmp == kDoubleExponentMask;
	}

	inline BASE_CONSTEXPR_FUNC float floor(float _a)
	{
		if (_a < 0.0f)
		{
	...
	inline BASE_CONSTEXPR_FUNC float ceil(float _a)
	{
		return -floor(-_a);
	}

	inline BASE_CONSTEXPR_FUNC float round(float _f)
	{
		return floor(_f + 0.5f);
	}

	inline BASE_CONSTEXPR_FUNC float lerp(float _a, float _b, float _t)
	{
		// Reference(s):
	...
	inline BASE_CONSTEXPR_FUNC float invLerp(float _a, float _b, float _value)
	{
		return (_value - _a) / (_b - _a);
	}

	inline BASE_CONSTEXPR_FUNC float sign(float _a)
	{
		return float( (0.0f < _a) - (0.0f > _a) );
	}

	inline BASE_CONSTEXPR_FUNC bool signbit(float _a)
	{
		return -0.0f == _a ? 0.0f != _a : 0.0f > _a;
	}

	inline BASE_CONSTEXPR_FUNC float copysign(float _value, float _sign)
	{
	...
	inline BASE_CONSTEXPR_FUNC float abs(float _a)
	{
		return _a < 0.0f ? -_a : _a;
	}

	inline BASE_CONSTEXPR_FUNC float square(float _a)
	{
		return _a * _a;
	}

	inline BASE_CONST_FUNC float sin(float _a)
	{
		return cos(_a - kPiHalf);
	}

	inline BASE_CONST_FUNC float sinh(float _a)
	{
		return 0.5f*(exp(_a) - exp(-_a) );
	}

	inline BASE_CONST_FUNC float asin(float _a)
	{
		return kPiHalf - acos(_a);
	}

	inline BASE_CONST_FUNC float cosh(float _a)
	{
		return 0.5f*(exp(_a) + exp(-_a) );
	}

	inline BASE_CONST_FUNC float tan(float _a)
	{
		return sin(_a) / cos(_a);
	}

	inline BASE_CONST_FUNC float tanh(float _a)
	{
	...
	inline BASE_CONST_FUNC float atan(float _a)
	{
		return atan2(_a, 1.0f);
	}

	inline BASE_CONST_FUNC float pow(float _a, float _b)
	{
		return exp(_b * log(_a) );
	}

	inline BASE_CONST_FUNC float exp2(float _a)
	{
		return pow(2.0f, _a);
	}

	template<>
	inline BASE_CONST_FUNC float log2(float _a)
	{
		return log(_a) * kInvLogNat2;
	}

	template<>
	inline BASE_CONST_FUNC int32_t log2(int32_t _a)
	{
		return 31 - uint32_cntlz(_a);
	}

	inline BASE_CONST_FUNC float rsqrtRef(float _a)
	{
		if (_a < kNearZero)
		{
	...
	inline BASE_CONST_FUNC float rsqrtSimd(float _a)
	{
		if (_a < kNearZero)
		{
			return kFloatInfinity;
	...
	inline BASE_CONST_FUNC float sqrtRef(float _a)
	{
		if (_a < 0.0F)
		{
	...
	inline BASE_CONST_FUNC float sqrtSimd(float _a)
	{
		if (_a < 0.0F)
		{
			return bitsToFloat(kFloatExponentMask | kFloatMantissaMask);
	...
	inline BASE_CONST_FUNC float rsqrt(float _a)
	{
#if BASE_CONFIG_SUPPORTS_SIMD
		return rsqrtSimd(_a);
#else
		return rsqrtRef(_a);
#endif // BASE_CONFIG_SUPPORTS_SIMD
	}

	inline BASE_CONST_FUNC float sqrt(float _a)
	{
#if BASE_CONFIG_SUPPORTS_SIMD
		return sqrtSimd(_a);
#else
	...
	inline BASE_CONSTEXPR_FUNC float trunc(float _a)
	{
		return float(int(_a) );
	}

	inline BASE_CONSTEXPR_FUNC float fract(float _a)
	{
		return _a - trunc(_a);
	}

	inline BASE_CONSTEXPR_FUNC float nms(float _a, float _b, float _c)
	{
		return _c - _a * _b;
	}

	inline BASE_CONSTEXPR_FUNC float add(float _a, float _b)
	{
		return _a + _b;
	}

	inline BASE_CONSTEXPR_FUNC float sub(float _a, float _b)
	{
		return _a - _b;
	}

	inline BASE_CONSTEXPR_FUNC float mul(float _a, float _b)
	{
		return _a * _b;
	}

	inline BASE_CONSTEXPR_FUNC float mad(float _a, float _b, float _c)
	{
		return add(mul(_a, _b), _c);
	}

	inline BASE_CONSTEXPR_FUNC float rcp(float _a)
	{
		return 1.0f / _a;
	}

	inline BASE_CONSTEXPR_FUNC float mod(float _a, float _b)
	{
		return _a - _b * floor(_a / _b);
	}

	inline BASE_CONSTEXPR_FUNC bool isEqual(float _a, float _b, float _epsilon)
	{
		// Reference(s):
	...
	inline BASE_CONST_FUNC bool isEqual(const float* _a, const float* _b, uint32_t _num, float _epsilon)
	{
	...
	inline BASE_CONSTEXPR_FUNC float wrap(float _a, float _wrap)
	{
	...
	inline BASE_CONSTEXPR_FUNC float step(float _edge, float _a)
	{
		return _a < _edge ? 0.0f : 1.0f;
	}

	inline BASE_CONSTEXPR_FUNC float pulse(float _a, float _start, float _end)
	{
		return step(_a, _start) - step(_a, _end);
	}

	inline BASE_CONSTEXPR_FUNC float smoothStep(float _a)
	{
		return square(_a)*(3.0f - 2.0f*_a);
	}

	inline BASE_CONST_FUNC float invSmoothStep(float _a)
	{
		return 0.5f - sin(asin(1.0f - 2.0f * _a) / 3.0f);
	}

	inline BASE_CONSTEXPR_FUNC float bias(float _time, float _bias)
	{
		return _time / ( ( (1.0f/_bias - 2.0f)*(1.0f - _time) ) + 1.0f);
	}

	inline BASE_CONSTEXPR_FUNC float gain(float _time, float _gain)
	{
		// Reference(s):
	...
	inline BASE_CONSTEXPR_FUNC float angleDiff(float _a, float _b)
	{
		const float dist = wrap(_b - _a, kPi2);
		return wrap(dist*2.0f, kPi2) - dist;
	}

	inline BASE_CONSTEXPR_FUNC float angleLerp(float _a, float _b, float _t)
	{
	...
	inline BASE_CONSTEXPR_FUNC Vec3 round(const Vec3 _a)
	{
		return
		{
			round(_a.x),
	...
	inline BASE_CONSTEXPR_FUNC Vec3 abs(const Vec3 _a)
	{
		return
		{
			abs(_a.x),
	...
	inline BASE_CONSTEXPR_FUNC Vec3 neg(const Vec3 _a)
	{
		return
		{
			-_a.x,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 add(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			_a.x + _b.x,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 add(const Vec3 _a, float _b)
	{
		return
		{
			_a.x + _b,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 sub(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			_a.x - _b.x,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 sub(const Vec3 _a, float _b)
	{
		return
		{
			_a.x - _b,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 mul(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			_a.x * _b.x,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 mul(const Vec3 _a, float _b)
	{
		return
		{
			_a.x * _b,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 div(const Vec3 _a, const Vec3 _b)
	{
		return mul(_a, rcp(_b) );
	}

	inline BASE_CONSTEXPR_FUNC Vec3 div(const Vec3 _a, float _b)
	{
		return mul(_a, rcp(_b) );
	}

	inline BASE_CONSTEXPR_FUNC Vec3 nms(const Vec3 _a, const float _b, const Vec3 _c)
	{
		return sub(_c, mul(_a, _b) );
	}

	inline BASE_CONSTEXPR_FUNC Vec3 nms(const Vec3 _a, const Vec3 _b, const Vec3 _c)
	{
		return sub(_c, mul(_a, _b) );
	}

	inline BASE_CONSTEXPR_FUNC Vec3 mad(const Vec3 _a, const float _b, const Vec3 _c)
	{
		return add(mul(_a, _b), _c);
	}

	inline BASE_CONSTEXPR_FUNC Vec3 mad(const Vec3 _a, const Vec3 _b, const Vec3 _c)
	{
		return add(mul(_a, _b), _c);
	}

	inline BASE_CONSTEXPR_FUNC float dot(const Vec3 _a, const Vec3 _b)
	{
		return _a.x*_b.x + _a.y*_b.y + _a.z*_b.z;
	}

	inline BASE_CONSTEXPR_FUNC Vec3 cross(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			_a.y*_b.z - _a.z*_b.y,
	...
	inline BASE_CONST_FUNC float length(const Vec3 _a)
	{
		return sqrt(dot(_a, _a) );
	}

	inline BASE_CONST_FUNC float distanceSq(const Vec3 _a, const Vec3 _b)
	{
		const Vec3 ba = sub(_b, _a);
		return dot(ba, ba);
	}

	inline BASE_CONST_FUNC float distance(const Vec3 _a, const Vec3 _b)
	{
		return length(sub(_b, _a) );
	}

	inline BASE_CONSTEXPR_FUNC Vec3 lerp(const Vec3 _a, const Vec3 _b, float _t)
	{
		return
		{
			lerp(_a.x, _b.x, _t),
	...
	inline BASE_CONSTEXPR_FUNC Vec3 lerp(const Vec3 _a, const Vec3 _b, const Vec3 _t)
	{
		return
		{
			lerp(_a.x, _b.x, _t.x),
	...
	inline BASE_CONST_FUNC Vec3 normalize(const Vec3 _a)
	{
	...
	inline BASE_CONSTEXPR_FUNC Vec3 min(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			min(_a.x, _b.x),
	...
	inline BASE_CONSTEXPR_FUNC Vec3 max(const Vec3 _a, const Vec3 _b)
	{
		return
		{
			max(_a.x, _b.x),
	...
	inline BASE_CONSTEXPR_FUNC Vec3 rcp(const Vec3 _a)
	{
		return
		{
			1.0f / _a.x,
	...
	inline BASE_CONSTEXPR_FUNC bool isEqual(const Vec3 _a, const Vec3 _b, float _epsilon)
	{
	...
	inline BASE_CONST_FUNC Vec3 fromLatLong(float _u, float _v)
	{
	...
	inline BASE_CONSTEXPR_FUNC Quaternion invert(const Quaternion _a)
	{
		return
		{
			-_a.x,
	...
	inline BASE_CONSTEXPR_FUNC Vec3 mulXyz(const Quaternion _a, const Quaternion _b)
	{
		const float ax = _a.x;
		const float ay = _a.y;
		const float az = _a.z;
		...
		return
		{
			aw * base + ax * bw + ay * bz - az * by,
			aw * by - ax * bz + ay * bw + az * base,
			aw * bz + ax * by - ay * base + az * bw,
		};
	}

	inline BASE_CONSTEXPR_FUNC Quaternion add(const Quaternion _a, const Quaternion _b)
	{
		return
		{
			_a.x + _b.x,
	...
	inline BASE_CONSTEXPR_FUNC Quaternion sub(const Quaternion _a, const Quaternion _b)
	{
		return
		{
			_a.x - _b.x,
	...
	inline BASE_CONSTEXPR_FUNC Quaternion mul(const Quaternion _a, float _b)
	{
		return
		{
			_a.x * _b,
	...
	inline BASE_CONSTEXPR_FUNC Quaternion mul(const Quaternion _a, const Quaternion _b)
	{
		const float ax = _a.x;
		const float ay = _a.y;
		const float az = _a.z;
		...
		return
		{
			...
			aw * by - ax * bz + ay * bw + az * base,
			aw * bz + ax * by - ay * base + az * bw,
			aw * bw - ax * base - ay * by - az * bz,
		};
	}

	inline BASE_CONSTEXPR_FUNC Vec3 mul(const Vec3 _v, const Quaternion _q)
	{
	...
	inline BASE_CONSTEXPR_FUNC float dot(const Quaternion _a, const Quaternion _b)
	{
		return
			  _a.x * _b.x
			+ _a.y * _b.y
	...
	inline BASE_CONSTEXPR_FUNC Quaternion normalize(const Quaternion _a)
	{
	...
	inline BASE_CONSTEXPR_FUNC Quaternion lerp(const Quaternion _a, const Quaternion _b, float _t)
	{
	...
	inline BASE_CONST_FUNC Quaternion fromEuler(const Vec3 _euler)
	{
	...
	inline BASE_CONST_FUNC Vec3 toEuler(const Quaternion _a)
	{
		const float xx  = _a.x;
		const float yy  = _a.y;
		const float zz  = _a.z;
	...
	inline BASE_CONST_FUNC Vec3 toXAxis(const Quaternion _a)
	{
		const float xx  = _a.x;
		const float yy  = _a.y;
		const float zz  = _a.z;
	...
	inline BASE_CONST_FUNC Vec3 toYAxis(const Quaternion _a)
	{
		const float xx  = _a.x;
		const float yy  = _a.y;
		const float zz  = _a.z;
	...
	inline BASE_CONST_FUNC Vec3 toZAxis(const Quaternion _a)
	{
		const float xx  = _a.x;
		const float yy  = _a.y;
		const float zz  = _a.z;
	...
	inline BASE_CONST_FUNC Quaternion fromAxisAngle(const Vec3 _axis, float _angle)
	{
	...
	inline BASE_CONST_FUNC Quaternion rotateX(float _ax)
	{
	...
	inline BASE_CONST_FUNC Quaternion rotateY(float _ay)
	{
	...
	inline BASE_CONST_FUNC Quaternion rotateZ(float _az)
	{
	...
	inline BASE_CONSTEXPR_FUNC bool isEqual(const Quaternion _a, const Quaternion _b, float _epsilon)
	{
		return isEqual(_a.x, _b.x, _epsilon)
			&& isEqual(_a.y, _b.y, _epsilon)
			&& isEqual(_a.z, _b.z, _epsilon)
	...
	inline BASE_CONSTEXPR_FUNC float distance(const Plane& _plane, const Vec3& _pos)
	{
		return dot(_plane.normal, _pos) + _plane.dist;
	}

	inline BASE_CONSTEXPR_FUNC bool isEqual(const Plane& _a, const Plane& _b, float _epsilon)
	{
	...
	inline BASE_CONST_FUNC float toLinear(float _a)
	{
	...
	inline BASE_CONST_FUNC float toGamma(float _a)
	{
		const float lo     = _a * 12.92f;
