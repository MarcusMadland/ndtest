...
{
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_ld(const void* _ptr)
	{
	...
	template<>
	BASE_SIMD_FORCE_INLINE void simd_st(void* _ptr, simd256_ref_t& _a)
	{
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_ld(float _x, float _y, float _z, float _w, float _a, float _b, float _c, float _d)
	{
		simd256_ref_t result;
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_ild(uint32_t _x, uint32_t _y, uint32_t _z, uint32_t _w, uint32_t _a, uint32_t _b, uint32_t _c, uint32_t _d)
	{
		simd256_ref_t result;
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_splat(float _a)
	{
		simd256_ref_t result;
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_isplat(uint32_t _a)
	{
		simd256_ref_t result;
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_itof(simd256_ref_t _a)
	{
		simd256_ref_t result;
	...
	template<>
	BASE_SIMD_FORCE_INLINE simd256_ref_t simd_ftoi(simd256_ref_t _a)
	{
		simd256_ref_t result;
