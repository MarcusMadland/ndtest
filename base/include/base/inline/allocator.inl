...
#	error "Must be included from base/allocator.h"
#endif // BASE_ALLOCATOR_H_HEADER_GUARD

inline void* operator new(size_t, base::PlacementNewTag, void* _ptr)
{
	return _ptr;
}

inline void operator delete(void*, base::PlacementNewTag, void*) throw()
{
}
...
namespace base
{
	...
	inline void* alignPtr(void* _ptr, size_t _extra, size_t _align)
	{
		...
		uintptr_t aligned = base::alignUp(unaligned, int32_t(_align) );
		un.addr = aligned;
		return un.ptr;
	}
